<h1 align="center"> Wall Mosaic — Help<br>Version 1.3</h1>

Wall Mosaic helps you design picture wall layouts using real-world dimensions—so you can plan everything before you start putting nail holes in the wall.

---

## Overview

Wall Mosaic lets you:

- Create a wall from dimensions or a photo  
- Add framed pictures with real sizes  
- Arrange and align layouts visually  
- Group and lock placements  
- Generate an installation guide for hanging  
...
There is a wonderfully easy two step process:
 ...
 - Take a photo of that picture and then use **Add Picture** to create a picture to place on the wall
...
## New in this version
 - Installation report in Word or PDF format
 - Bug fix: drag group anywhere on wall
 - Bug fix: group ownership saved in project
